...
class BuilderHelper<T extends GetxController> extends StatefulWidget {
  ...
  final void Function(BuilderHelper oldWidget, BindBuilderState<T> state)?
      didUpdateWidget;
  final T? init;
...
class BindBuilderState<T extends GetxController> extends State<BuilderHelper<T>>
  ...
  void dispose() {
    ...
    PrintHelper.logSystem("$T: Disposed");
  ...
  @override
  void didUpdateWidget(BuilderHelper oldWidget) {
    super.didUpdateWidget(oldWidget as BuilderHelper<T>);
