...
class PrintUtil {
  ...
  static void logInfo(dynamic messages) {
    ...
    if (kDebugMode) {
      _printer(
          '\x1B[40m\x1B[1m\x1B[36m($date)\x1B[0m $infoIcon \x1B[1m\x1B[34m$messages\x1B[0m');
    }
  }
  ...
  static void logWarning(dynamic messages) {
    ...
    if (kDebugMode) {
      _printer(
          '\x1B[40m\x1B[1m\x1B[36m($date)\x1B[0m $warningIcon \x1B[1m\x1B[33m$messages\x1B[0m');
    }
  }
  ...
  static void logError(dynamic messages) {
    ...
    if (kDebugMode) {
      _printer(
          '\x1B[40m\x1B[1m\x1B[36m($date)\x1B[0m $errorIcon \x1B[1m\x1B[35m$messages\x1B[0m');
    }
  }
}
